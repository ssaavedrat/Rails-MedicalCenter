...
class TreatmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create treatment" do
    assert_difference("Treatment.count") do
      post treatments_url, params: { treatment: { date: @treatment.date, description: @treatment.description, name: @treatment.name } }
    end
  ...
  test "should update treatment" do
    patch treatment_url(@treatment), params: { treatment: { date: @treatment.date, description: @treatment.description, name: @treatment.name } }
